...
const translations = [
  ...
  // ── Tafel
  { nl: 'Tafel', en: 'Table', fr: 'Table', de: 'Tisch', category: 'Tafel' },
  { nl: 'Tafel voor 2 personen', en: 'Table for 2', fr: 'Table pour 2', de: 'Tisch für 2', category: 'Tafel' },
  { nl: 'Tafel voor 4 personen', en: 'Table for 4', fr: 'Table pour 4', de: 'Tisch für 4', category: 'Tafel' },
  { nl: 'Vrije tafel', en: 'Free table', fr: 'Table libre', de: 'Freier Tisch', category: 'Tafel' },
  { nl: 'Bezette tafel', en: 'Occupied table', fr: 'Table occupée', de: 'Besetzter Tisch', category: 'Tafel' },
  { nl: 'Uw tafel is klaar', en: 'Your table is ready', fr: 'Votre table est prête', de: 'Ihr Tisch ist bereit', category: 'Tafel' },
  { nl: 'Wacht u even in de bar?', en: 'Would you mind waiting at the bar?', fr: 'Pouvez-vous patienter au bar ?', de: 'Warten Sie kurz an der Bar?', category: 'Tafel' },
  { nl: 'Raam- of terrasplaats?', en: 'Window or terrace seat?', fr: 'Côté fenêtre ou terrasse ?', de: 'Fenster- oder Terrassenplatz?', category: 'Tafel' },
  { nl: 'Wachttijd', en: 'Waiting time', fr: "Temps d'attente", de: 'Wartezeit', category: 'Tafel' },
  { nl: 'Wachtlijst', en: 'Waiting list', fr: "Liste d'attente", de: 'Warteliste', category: 'Tafel' },
  { nl: 'Roken of niet-roken?', en: 'Smoking or non-smoking?', fr: 'Fumeur ou non-fumeur ?', de: 'Raucher oder Nichtraucher?', category: 'Tafel' },

  // ── Suggesties & bestellen
  { nl: 'Suggesties', en: 'Suggestions', fr: 'Suggestions', de: 'Empfehlungen', category: 'Suggesties' },
  { nl: 'Suggestie van de dag', en: "Today's suggestion", fr: 'Suggestion du jour', de: 'Empfehlung des Tages', category: 'Suggesties' },
  { nl: 'De chef raadt aan', en: 'The chef recommends', fr: 'Le chef recommande', de: 'Der Chef empfiehlt', category: 'Suggesties' },
  { nl: 'Wij raden dit aan', en: 'We recommend this', fr: 'Nous recommandons ceci', de: 'Wir empfehlen dies', category: 'Suggesties' },
  { nl: 'Seizoensgerecht', en: 'Seasonal dish', fr: 'Plat de saison', de: 'Saisonales Gericht', category: 'Suggesties' },
  { nl: 'Specialiteit van het huis', en: 'House specialty', fr: 'Spécialité de la maison', de: 'Hausspezialität', category: 'Suggesties' },
  { nl: 'Onze aanrader', en: 'Our recommendation', fr: 'Notre coup de cœur', de: 'Unsere Empfehlung', category: 'Suggesties' },
  { nl: 'Nieuw op de kaart', en: 'New on the menu', fr: 'Nouveau sur la carte', de: 'Neu auf der Karte', category: 'Suggesties' },
  { nl: 'Bijzonder populair', en: 'Very popular', fr: 'Très populaire', de: 'Sehr beliebt', category: 'Suggesties' },
  { nl: 'Goed gecombineerd met', en: 'Pairs well with', fr: 'Se marie bien avec', de: 'Passt gut zu', category: 'Suggesties' },

  // ── Meer oberzinnen
  { nl: 'Welkom!', en: 'Welcome!', fr: 'Bienvenue !', de: 'Willkommen!', category: 'Zinnen' },
  { nl: 'Goedemorgen', en: 'Good morning', fr: 'Bonjour', de: 'Guten Morgen', category: 'Zinnen' },
  { nl: 'Goedemiddag', en: 'Good afternoon', fr: 'Bonjour', de: 'Guten Tag', category: 'Zinnen' },
  { nl: 'Goedenavond', en: 'Good evening', fr: 'Bonsoir', de: 'Guten Abend', category: 'Zinnen' },
  { nl: 'Smakelijk!', en: 'Enjoy your meal!', fr: 'Bon appétit !', de: 'Guten Appetit!', category: 'Zinnen' },
  { nl: 'Geniet u ervan!', en: 'Enjoy!', fr: 'Profitez-en !', de: 'Genießen Sie es!', category: 'Zinnen' },
  { nl: 'Heeft u al gekozen?', en: 'Have you decided yet?', fr: 'Avez-vous déjà choisi ?', de: 'Haben Sie schon gewählt?', category: 'Zinnen' },
  { nl: 'Mag ik uw bestelling opnemen?', en: 'May I take your order?', fr: 'Puis-je prendre votre commande ?', de: 'Darf ich Ihre Bestellung aufnehmen?', category: 'Zinnen' },
  { nl: 'Wilt u een aperitief?', en: 'Would you like an aperitif?', fr: 'Désirez-vous un apéritif ?', de: 'Möchten Sie einen Aperitif?', category: 'Zinnen' },
  { nl: 'Wilt u de dessertkaart?', en: 'Would you like the dessert menu?', fr: 'Souhaitez-vous la carte des desserts ?', de: 'Möchten Sie die Dessertkarte?', category: 'Zinnen' },
  { nl: 'Wilt u koffie na het eten?', en: 'Would you like coffee after dinner?', fr: 'Souhaitez-vous un café après le repas ?', de: 'Möchten Sie nach dem Essen einen Kaffee?', category: 'Zinnen' },
  { nl: 'Is alles naar uw wens?', en: 'Is everything to your liking?', fr: 'Est-ce que tout est à votre goût ?', de: 'Ist alles nach Ihrem Wunsch?', category: 'Zinnen' },
  { nl: 'Mag ik uw bord meenemen?', en: 'May I clear your plate?', fr: 'Puis-je débarrasser votre assiette ?', de: 'Darf ich Ihren Teller mitnehmen?', category: 'Zinnen' },
  { nl: 'Dit gerecht is uitverkocht', en: 'This dish is sold out', fr: 'Ce plat est épuisé', de: 'Dieses Gericht ist ausverkauft', category: 'Zinnen' },
  { nl: 'Dat is inbegrepen', en: 'That is included', fr: "C'est inclus", de: 'Das ist inbegriffen', category: 'Zinnen' },
  { nl: 'Dat is apart te bestellen', en: 'That is ordered separately', fr: 'Cela se commande séparément', de: 'Das wird separat bestellt', category: 'Zinnen' },
  { nl: 'Met supplement', en: 'With extra charge', fr: 'Avec supplément', de: 'Mit Aufpreis', category: 'Zinnen' },
  { nl: 'Zonder supplement', en: 'No extra charge', fr: 'Sans supplément', de: 'Ohne Aufpreis', category: 'Zinnen' },
  { nl: 'Wilt u iets anders?', en: 'Would you like something else?', fr: 'Désirez-vous autre chose ?', de: 'Möchten Sie etwas anderes?', category: 'Zinnen' },
  { nl: 'Excuseer het ongemak', en: 'Sorry for the inconvenience', fr: 'Désolé pour la gêne occasionnée', de: 'Entschuldigung für die Unannehmlichkeit', category: 'Zinnen' },
  { nl: 'Dat los ik meteen op', en: 'I will sort that right away', fr: 'Je règle ça tout de suite', de: 'Das kläre ich sofort', category: 'Zinnen' },
  { nl: 'Wij sluiten om ...u', en: 'We close at ...', fr: 'Nous fermons à ...h', de: 'Wir schließen um ... Uhr', category: 'Zinnen' },
  { nl: 'De keuken sluit om ...u', en: 'The kitchen closes at ...', fr: 'La cuisine ferme à ...h', de: 'Die Küche schließt um ...', category: 'Zinnen' },
  { nl: 'De suggesties staan rechts op het blaadje', en: 'The suggestions are on the right side of the menu', fr: 'Les suggestions se trouvent à droite sur la carte', de: 'Die Empfehlungen stehen rechts auf der Karte', category: 'Zinnen' },
  { nl: 'Het menu is beschikbaar in uw taal via de QR-code', en: 'The menu is available in your language by scanning the QR code', fr: 'Le menu est disponible dans votre langue en scannant le QR code', de: 'Die Speisekarte ist in Ihrer Sprache verfügbar, wenn Sie den QR-Code scannen', category: 'Zinnen' },
];
